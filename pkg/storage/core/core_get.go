...
func (s *Core) Get(ctx context.Context, gi *types.GetInput) (*types.GetOutput, error) {
	var t *trace.Task
...
func (s *Core) dimensionKeysByQuery(ctx context.Context, qry *flameql.Query) func() []dimension.Key {
...
func (s *Core) lookupDimension(m *flameql.TagMatcher) (*dimension.Dimension, bool) {
	return s.lookupDimensionKV(m.Key, m.Value)
}

func (s *Core) lookupDimensionRegex(m *flameql.TagMatcher) (*dimension.Dimension, bool) {
	d := dimension.New()
...
func (s *Core) lookupDimensionKV(k, v string) (*dimension.Dimension, bool) {
