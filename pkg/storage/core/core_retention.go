...
// func (s *Core) EnforceRetentionPolicy(ctx context.Context, rp *segment.RetentionPolicy) {
...
// func (s *Core) deleteSegmentData(ctx context.Context, k *segment.Key, rp *segment.RetentionPolicy) error {
// 	sk := k.SegmentKey()
...
// func (s *Core) reclaimSegmentSpace(k *segment.Key, size int64) error {
...
// func (s *Core) flushTreeBatch(batch *badger.WriteBatch) (*badger.WriteBatch, error) {
// 	if err := batch.Flush(); err != nil {
// 		return batch, err
// 	}
// 	select {
...
// func (s *Core) iterateOverAllSegments(cb func(*segment.Key) error) error {
// 	nameKey := "__name__"
