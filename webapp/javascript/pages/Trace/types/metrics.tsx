...
export type AvailableServiceMetrics =
  | 'service_call_rate'
  | 'service_latencies'
  | 'service_error_rate';
...
export type FetchedAllServiceMetricsResponse = [
  (
    | PromiseFulfilledResult<
        MetricsAPIServiceResponseData<'service_latencies', 0.5>
      >
    | PromiseRejectedResult
  ),
  (
    | PromiseFulfilledResult<
        MetricsAPIServiceResponseData<'service_latencies', 0.75>
      >
    | PromiseRejectedResult
  ),
  (
    | PromiseFulfilledResult<MetricsAPIServiceResponseData<'service_latencies'>>
    | PromiseRejectedResult
  ),
  (
    | PromiseFulfilledResult<MetricsAPIServiceResponseData<'service_call_rate'>>
    | PromiseRejectedResult
  ),
  (
    | PromiseFulfilledResult<
        MetricsAPIServiceResponseData<'service_error_rate'>
      >
    | PromiseRejectedResult
  )
];
...
export type FetchAggregatedServiceMetricsResponse = [
  (
    | PromiseFulfilledResult<
        MetricsAPIOpsResponseData<'service_operation_latencies'>
      >
    | PromiseRejectedResult
  ),
  (
    | PromiseFulfilledResult<
        MetricsAPIOpsResponseData<'service_operation_call_rate'>
      >
    | PromiseRejectedResult
  ),
  (
    | PromiseFulfilledResult<
        MetricsAPIOpsResponseData<'service_operation_error_rate'>
      >
    | PromiseRejectedResult
  )
];
